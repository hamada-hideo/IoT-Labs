...
SENSOR_READING_ACTUATOR_CONTROL_WEBSERVER_PORT = 8081
SENSOR_READING_WEBSERVER_ENDPOINT = "sensors"
ACTUATOR_CONTROL_WEBSERVER_ENDPOINT = "actuators"
LOGGER_WEBSERVICE_IP = "127.0.0.1"
LOGGER_WEBSERVICE_PORT = 8082
LOGGER_WEBSERVICE_ENDPOINT = "log"
